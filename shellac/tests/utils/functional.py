...
class FunctionalTest(StaticLiveServerTestCase):
    ...
    def wait_to_be_signed_in(self, username):
        self.wait_for_element_with_id('nav-navbar-right-bar-help')
        help = self.browser.find_element_by_css_selector('#nav-navbar-right-bar-help')
        self.assertEqual('Help', help.text)
